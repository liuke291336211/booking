            ...
            <div class="row-fluid">
                <div class="span9">
                    <div class="alert alert-info padTB20 relatedDept">
                        <h3 class="search_hospital relatedDept_right">共有 <span class="redTow">${officeList.size()}</span> 个科室</h3>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="top wid25">
                                    <ul class="unstyled hospitalShow">
                                        <li><span class="muted"><b>${office.officename}</b></span>
                                       </li>
                                    </ul>
                                </td>
                                <td class="wid10">
                                    <p><a href="${pageContext.request.contextPath}/office/showOffice.do?officeid=${office.id}" class="btn btn_red">查看科室</a></p>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
