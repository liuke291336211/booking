    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/user/findAll.do">科室管理</a></li>
                <li class="active">科室详情列表</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
                ...
                <div class="box-body">
                    <div class="tab-pane" id="tab-treetable">
                        <table id="collapse-table" class="table table-bordered table-hover dataTable">
                            ...
                            <tr data-tt-id="0"a>
                                <td colspan="2">科室所属的医生列表</td>
                            </tr>
                            <tbody>
                            <c:forEach items="${doctors}" var="doctor">
                                <tr data-tt-id="${doctor.id}" data-tt-parent-id="0">
