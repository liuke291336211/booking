...
jQuery.fn.rater	= function(options) {
    ...
    var settings = {
        ...
        title_format	: null,
        info_format	: null,
        image	: rootUrl() + '/img/stars.jpg',
        imageAll :rootUrl() +  '/img/stars-all.gif',
        defaultTips :true,
        clickTips :true,
        width	: 24,
        height	: 24
    ...
    content.find('.rater-star-item').mouseover(function() {
        ...
        if (typeof settings.title_format == 'function') {
            jQuery(this).parents().nextAll('.rater-star-result').attr({"name":"degree" ,"value":current_value}).html(current_value+'分&nbsp;'+settings.title_format(current_value));
        }
