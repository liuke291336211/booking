            ...
            <section class="content">
                    <div class="tab-content">
                        <div class="box box-primary">
                            <!--label显示的内容-->
                            <form action="${pageContext.request.contextPath}/office/saveOffice.do" method="post">
                                <div class="tab-pane active" id="tab-label">
                                    <h5>科室信息</h5>
                                    <div class="row data-type text-center">

                                        <div class="col-md-2 title">科室名称</div>
                                        <div class="col-md-4 data text">
                                            <input type="text" class="form-control" name="officename" placeholder="科室名称" value="">
                                        </div>
