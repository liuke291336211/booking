            ...
            <c:forEach items="${doctorDetails}" var="doctor">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red">
                        <div class="inner">
                            <h3>${doctor.key.doctorname}</h3>

                            <p>  ${doctor.value}  条评论</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-pie-graph"></i>
                        </div>
                        <a href="${pageContext.request.contextPath}/countDoctor/showDetail.do?id=${doctor.key.id}" class="small-box-footer">
                            评 价 详 情 <i class="fa fa-arrow-circle-back"></i>
                        </a>
                    </div>
                </div>
            </c:forEach>
